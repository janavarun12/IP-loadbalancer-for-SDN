...
class iplb (object):
  ...
  def _pick_server (self, key, inport):
    ...
    """
    global port_bytes
    print("PORT_BYTES ARE:",port_bytes)
    print(switch_stat)

    min_port = min(port_bytes, key=port_bytes.get)
    print("MIN bytes are:",port_bytes[min_port],"PORT NO:",min_port,"IP of MIN port:",self.port_ip_map[min_port])
    
    return (self.port_ip_map[min_port])
